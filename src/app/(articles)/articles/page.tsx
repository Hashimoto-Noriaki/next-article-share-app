        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow flex flex-col items-center justify-start mt-5">
                ...
                <div className="flex flex-wrap justify-center gap-5 mt-5">
                    <p className="w-64 h-40 bg-rose-200 rounded-xl flex items-center justify-center">記事カード1</p>
                    <p className="w-64 h-40 bg-cyan-200 rounded-xl flex items-center justify-center">記事カード2</p>
                    <p className="w-64 h-40 bg-emerald-200 rounded-xl flex items-center justify-center">記事カード3</p>
                </div>
            </main>
            <Footer/>
        </div>
